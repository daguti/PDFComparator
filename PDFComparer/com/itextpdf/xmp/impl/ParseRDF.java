...
/*      */ 
/*  237 */       if ((!"xmlns".equals(attribute.getPrefix())) && ((attribute.getPrefix() != null) || (!"xmlns".equals(attribute.getNodeName()))))
/*      */       {
...
/*      */             else
/*      */             {
/*  274 */               xmpParent.setName(attribute.getNodeValue()); }  } break;
/*      */         case 0:
...
/*  393 */     List nsAttrs = null;
/*  394 */     for (int i = 0; i < attributes.getLength(); i++)
/*      */     {
/*  396 */       Node attribute = attributes.item(i);
/*  397 */       if (("xmlns".equals(attribute.getPrefix())) || ((attribute.getPrefix() == null) && ("xmlns".equals(attribute.getNodeName()))))
/*      */       {
/*  400 */         if (nsAttrs == null)
/*      */         {
...
/*  407 */     if (nsAttrs != null)
/*      */     {
/*  409 */       for (it = nsAttrs.iterator(); it.hasNext(); )
/*      */       {
/*  411 */         String ns = (String)it.next();
...
/*      */     else
/*      */     {
/*  428 */       for (int i = 0; i < attributes.getLength(); i++)
/*      */       {
...
/*  434 */         if ((!"xml:lang".equals(attribute.getNodeName())) || (("ID".equals(attrLocal)) && ("http://www.w3.org/1999/02/22-rdf-syntax-ns#".equals(attrNS))))
/*      */         {
...
/*      */       {
/*  471 */         for (int i = 0; i < xmlNode.getChildNodes().getLength(); i++)
/*      */         {
...
/*  522 */       if ((!"xmlns".equals(attribute.getPrefix())) && ((attribute.getPrefix() != null) || (!"xmlns".equals(attribute.getNodeName()))))
/*      */       {
...
/*      */ 
/*  550 */     for (int i = 0; i < xmlNode.getChildNodes().getLength(); i++)
/*      */     {
/*  552 */       currChild = xmlNode.getChildNodes().item(i);
...
/*      */           {
/*  570 */             newCompound.getOptions().setArray(true).setArrayOrdered(true).setArrayAlternate(true);
/*      */           }
/*      */           else
/*      */           {
...
/*  646 */       if ((!"xmlns".equals(attribute.getPrefix())) && ((attribute.getPrefix() != null) || (!"xmlns".equals(attribute.getNodeName()))))
/*      */       {
...
/*      */         }
/*  658 */         else if ((!"http://www.w3.org/1999/02/22-rdf-syntax-ns#".equals(attrNS)) || ((!"ID".equals(attrLocal)) && (!"datatype".equals(attrLocal))))
/*      */         {
...
/*  670 */     for (int i = 0; i < xmlNode.getChildNodes().getLength(); i++)
/*      */     {
/*  672 */       Node child = xmlNode.getChildNodes().item(i);
...
/*  727 */       if ((!"xmlns".equals(attribute.getPrefix())) && ((attribute.getPrefix() != null) || (!"xmlns".equals(attribute.getNodeName()))))
/*      */       {
...
/*      */         }
/*  739 */         else if ((!"http://www.w3.org/1999/02/22-rdf-syntax-ns#".equals(attrNS)) || ((!"ID".equals(attrLocal)) && (!"parseType".equals(attrLocal))))
/*      */         {
...
/*  855 */       if ((!"xmlns".equals(attribute.getPrefix())) && ((attribute.getPrefix() != null) || (!"xmlns".equals(attribute.getNodeName()))))
/*      */       {
...
/*  898 */           break;
/*      */         case 0:
/*  901 */           if (("value".equals(attribute.getLocalName())) && ("http://www.w3.org/1999/02/22-rdf-syntax-ns#".equals(attribute.getNamespaceURI())))
/*      */           {
...
/*  911 */             valueNode = attribute;
/*      */           }
/*  913 */           else if (!"xml:lang".equals(attribute.getNodeName()))
/*      */           {
/*  915 */             hasPropertyAttrs = true; } break;
/*      */         case 1:
/*      */         case 3:
/*      */         case 4:
/*      */         default:
...
/*      */     }
/*      */ 
/*  949 */     for (int i = 0; i < xmlNode.getAttributes().getLength(); i++)
/*      */     {
/*  951 */       Node attribute = xmlNode.getAttributes().item(i);
/*  952 */       if ((attribute != valueNode) && (!"xmlns".equals(attribute.getPrefix())) && ((attribute.getPrefix() != null) || (!"xmlns".equals(attribute.getNodeName()))))
/*      */       {
...
/*      */           {
/*  974 */             addQualifierNode(childNode, attribute.getNodeName(), attribute.getNodeValue());
/*      */           }
/*  977 */           else if ("xml:lang".equals(attribute.getNodeName()))
/*      */           {
...
/*      */     }
/*      */ 
/* 1162 */     for (int i = 1; i <= valueNode.getQualifierLength(); i++)
/*      */     {
/* 1164 */       XMPNode qualifier = valueNode.getQualifier(i);
/* 1165 */       xmpParent.addQualifier(qualifier);
/*      */     }
/*      */ 
/* 1171 */     for (int i = 2; i <= xmpParent.getChildrenLength(); i++)
/*      */     {
...
/* 1187 */     for (Iterator it = valueNode.iterateChildren(); it.hasNext(); )
/*      */     {
/* 1189 */       XMPNode child = (XMPNode)it.next();
...
/*      */ 
/* 1280 */     if ((namespace == null) && (("about".equals(localName)) || ("ID".equals(localName))) && ((node instanceof Attr)) && ("http://www.w3.org/1999/02/22-rdf-syntax-ns#".equals(((Attr)node).getOwnerElement().getNamespaceURI())))
/*      */     {
 ...
 * Qualified Name:     com.itextpdf.xmp.impl.ParseRDF
