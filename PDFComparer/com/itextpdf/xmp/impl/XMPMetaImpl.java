...
/*      */ 
/*  290 */       String fieldPath = structName + XMPPathFactory.composeStructFieldPath(fieldNS, fieldName);
/*      */ 
...
/*      */ 
/*  502 */     for (Iterator it = arrayNode.iterateChildren(); it.hasNext(); )
/*      */     {
/*  504 */       XMPNode currItem = (XMPNode)it.next();
/*  505 */       if ((!currItem.hasQualifier()) || (!"xml:lang".equals(currItem.getQualifier(1).getName())))
/*      */       {
...
/*      */       {
/*  544 */         XMPNodeUtils.appendLangItem(arrayNode, specificLang, itemValue); } break;
/*      */     case 1:
/*  550 */       if (!specificXDefault)
/*      */       {
/*  554 */         if ((haveXDefault) && (xdItem != itemNode) && (xdItem != null) && (xdItem.getValue().equals(itemNode.getValue())))
/*      */         {
...
/*  566 */         for (Iterator it = arrayNode.iterateChildren(); it.hasNext(); )
/*      */         {
/*  568 */           XMPNode currItem = (XMPNode)it.next();
/*  569 */           if (currItem != xdItem) if (currItem.getValue().equals(xdItem != null ? xdItem.getValue() : null))
/*      */             {
...
/*  578 */         if (xdItem != null)
/*      */         {
/*  580 */           xdItem.setValue(itemValue); }  } break;
/*      */     case 2:
/*  589 */       if ((haveXDefault) && (xdItem != itemNode) && (xdItem != null) && (xdItem.getValue().equals(itemNode.getValue())))
/*      */       {
...
/* 1414 */       break;
/*      */     case 2:
/* 1416 */       value = new Integer(XMPUtils.convertToInteger(rawValue));
/* 1417 */       break;
/*      */     case 3:
/* 1419 */       value = new Long(XMPUtils.convertToLong(rawValue));
/* 1420 */       break;
/*      */     case 4:
/* 1422 */       value = new Double(XMPUtils.convertToDouble(rawValue));
/* 1423 */       break;
/*      */     case 5:
/* 1425 */       value = XMPUtils.convertToDate(rawValue);
/* 1426 */       break;
/*      */     case 6:
/* 1428 */       XMPDateTime dt = XMPUtils.convertToDate(rawValue);
/* 1429 */       value = dt.getCalendar();
/* 1430 */       break;
/*      */     case 7:
/* 1432 */       value = XMPUtils.decodeBase64(rawValue);
/* 1433 */       break;
/*      */     case 0:
/*      */     default:
/* 1440 */       value = (rawValue != null) || (propNode.getOptions().isCompositeProperty()) ? rawValue : "";
/*      */     }
/*      */ 
/* 1443 */     return value;
/*      */   }
 ...
 * Qualified Name:     com.itextpdf.xmp.impl.XMPMetaImpl
