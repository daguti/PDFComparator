...
/*     */     {
/* 125 */       schemaNode = new XMPNode(namespaceURI, new PropertyOptions().setSchemaNode(true));
/*     */ 
...
/*     */ 
/* 233 */     currNode = findSchemaNode(xmpTree, xpath.getSegment(0).getName(), createNodes);
/*     */ 
...
/*     */ 
/* 268 */           if ((i == 1) && (xpath.getSegment(i).isAlias()) && (xpath.getSegment(i).getAliasForm() != 0))
/*     */           {
/* 272 */             currNode.getOptions().setOption(xpath.getSegment(i).getAliasForm(), true);
/*     */           }
/* 275 */           else if ((i < xpath.size() - 1) && (xpath.getSegment(i).getKind() == 1) && (!currNode.getOptions().isCompositeProperty()))
/*     */           {
...
/*     */             {
/*     */               String strValue;
/* 436 */               if ((value instanceof XMPDateTime))
/*     */               {
...
/*     */               {
/*     */                 String strValue;
/* 440 */                 if ((value instanceof GregorianCalendar))
/*     */                 {
...
/*     */     {
/* 491 */       nextNode = findQualifierNode(parentNode, nextStep.getName().substring(1), createNodes);
/*     */     }
/*     */     else
/*     */     {
...
/* 523 */         index = lookupQualSelector(parentNode, qualName, qualValue, nextStep.getAliasForm());
/*     */       }
/*     */       else
/*     */       {
...
/* 679 */       int index = lookupLanguageItem(arrayNode, qualValue);
/* 680 */       if ((index < 0) && ((aliasForm & 0x1000) > 0))
/*     */       {
...
/*     */ 
/* 699 */       for (it = currItem.iterateQualifier(); it.hasNext(); )
/*     */       {
/* 701 */         XMPNode qualifier = (XMPNode)it.next();
/* 702 */         if ((qualName.equals(qualifier.getName())) && (qualValue.equals(qualifier.getValue())))
/*     */         {
/* 705 */           return index;
/*     */         }
/*     */       }
...
/*     */         catch (XMPException e)
/*     */         {
/* 746 */           if (!$assertionsDisabled) throw new AssertionError();
/*     */         }
/*     */ 
/* 749 */         if (i != 2)
/*     */           break;
/* 751 */         arrayNode.getChild(2).setValue(child.getValue()); break;
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 771 */       for (Iterator it = arrayNode.iterateChildren(); it.hasNext(); )
/*     */       {
/* 773 */         XMPNode child = (XMPNode)it.next();
...
/*     */ 
/* 854 */     for (Iterator it = arrayNode.iterateChildren(); it.hasNext(); )
/*     */     {
/* 856 */       XMPNode currItem = (XMPNode)it.next();
/*     */ 
/* 859 */       if (currItem.getOptions().isCompositeProperty())
/*     */       {
/* 861 */         throw new XMPException("Alt-text array item is not simple", 102);
/*     */       }
/* 863 */       if ((!currItem.hasQualifier()) || (!"xml:lang".equals(currItem.getQualifier(1).getName())))
/*     */       {
...
/*     */         }
/*     */ 
/* 884 */         foundGenericMatches++;
/*     */       }
/* 886 */       else if ("x-default".equals(currLang))
/*     */       {
 ...
 * Qualified Name:     com.itextpdf.xmp.impl.XMPNodeUtils
