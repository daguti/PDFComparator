...
/*     */   {
/* 142 */     return (XMPNode)getChildren().get(index - 1);
/*     */   }
/*     */ 
...
/*     */   {
/* 241 */     return this.children != null ? this.children.size() : 0;
/*     */   }
/*     */ 
...
/*     */   {
/* 263 */     return (XMPNode)getQualifier().get(index - 1);
/*     */   }
/*     */ 
/*     */   public int getQualifierLength()
/*     */   {
/* 272 */     return this.qualifier != null ? this.qualifier.size() : 0;
/*     */   }
/*     */ 
...
/* 301 */       getQualifier().add(!this.options.getHasLanguage() ? 0 : 1, qualNode);
/*     */     }
/*     */     else
/*     */     {
...
/*     */     try
/*     */     {
/* 473 */       for (Iterator it = iterateChildren(); it.hasNext(); )
/*     */       {
/* 475 */         XMPNode child = (XMPNode)it.next();
/* 476 */         destination.addChild((XMPNode)child.clone());
/*     */       }
/*     */ 
/* 479 */       for (it = iterateQualifier(); it.hasNext(); )
/*     */       {
/* 481 */         XMPNode qualifier = (XMPNode)it.next();
...
/*     */     {
/* 488 */       Iterator it;
/* 488 */       if (!$assertionsDisabled) throw new AssertionError();
/*     */     }
/*     */   }
/*     */ 
...
/* 669 */     if (hasQualifier())
/*     */     {
/* 671 */       XMPNode[] quals = (XMPNode[])getQualifier().toArray(new XMPNode[getQualifierLength()]);
/*     */ 
/* 673 */       int sortFrom = 0;
/*     */ 
/* 675 */       while ((quals.length > sortFrom) && (("xml:lang".equals(quals[sortFrom].getName())) || ("rdf:type".equals(quals[sortFrom].getName()))))
/*     */       {
/* 680 */         quals[sortFrom].sort();
/* 681 */         sortFrom++;
/*     */       }
/*     */ 
/* 684 */       Arrays.sort(quals, sortFrom, quals.length);
/* 685 */       ListIterator it = this.qualifier.listIterator();
...
/*     */       }
/* 701 */       for (it = iterateChildren(); it.hasNext(); )
/*     */       {
...
/*     */     {
/* 785 */       XMPNode[] quals = (XMPNode[])getQualifier().toArray(new XMPNode[getQualifierLength()]);
/*     */ 
/* 787 */       int i = 0;
/* 788 */       while ((quals.length > i) && (("xml:lang".equals(quals[i].getName())) || ("rdf:type".equals(quals[i].getName()))))
/*     */       {
/* 793 */         i++;
/*     */       }
/* 795 */       Arrays.sort(quals, i, quals.length);
/* 796 */       for (i = 0; i < quals.length; i++)
/*     */       {
/* 798 */         XMPNode qualifier = quals[i];
/* 799 */         qualifier.dumpNode(result, recursive, indent + 2, i + 1);
/*     */       }
/*     */ 
/*     */     }
/*     */ 
...
/*     */     {
/* 806 */       XMPNode[] children = (XMPNode[])getChildren().toArray(new XMPNode[getChildrenLength()]);
/*     */ 
/* 808 */       if (!getOptions().isArray())
/*     */       {
/* 810 */         Arrays.sort(children);
/*     */       }
/* 812 */       for (int i = 0; i < children.length; i++)
/*     */       {
/* 814 */         XMPNode child = children[i];
/* 815 */         child.dumpNode(result, recursive, indent + 1, i + 1);
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 898 */     if (list != null)
/*     */     {
/* 900 */       for (it = list.iterator(); it.hasNext(); )
/*     */       {
/* 902 */         XMPNode child = (XMPNode)it.next();
...
/*     */     throws XMPException
/*     */   {
/* 920 */     if ((!"[]".equals(childName)) && (findChildByName(childName) != null))
/*     */     {
...
/*     */     throws XMPException
/*     */   {
/* 936 */     if ((!"[]".equals(qualifierName)) && (findQualifierByName(qualifierName) != null))
/*     */     {
 ...
 * Qualified Name:     com.itextpdf.xmp.impl.XMPNode
