...
/*     */ {
/*  59 */   private Map namespaceToPrefixMap = new HashMap();
/*     */ 
/*  62 */   private Map prefixToNamespaceMap = new HashMap();
/*     */ 
/*  66 */   private Map aliasMap = new HashMap();
/*     */ 
...
/*     */     }
/*     */ 
/* 107 */     if (!Utils.isXMLNameNS(suggestedPrefix.substring(0, suggestedPrefix.length() - 1)))
/*     */     {
...
/*     */   {
/* 185 */     return Collections.unmodifiableMap(new TreeMap(this.namespaceToPrefixMap));
/*     */   }
/*     */ 
/*     */   public synchronized Map getPrefixes()
/*     */   {
/* 194 */     return Collections.unmodifiableMap(new TreeMap(this.prefixToNamespaceMap));
/*     */   }
/*     */ 
...
/* 312 */     if (prefix != null)
/*     */     {
/* 314 */       for (it = this.aliasMap.keySet().iterator(); it.hasNext(); )
/*     */       {
/* 316 */         String qname = (String)it.next();
...
/*     */     }
/*     */ 
/* 324 */     return (XMPAliasInfo[])result.toArray(new XMPAliasInfo[result.size()]);
/*     */   }
/*     */ 
...
/*     */ 
/* 373 */     final AliasOptions aliasOpts = aliasForm != null ? new AliasOptions(XMPNodeUtils.verifySetOptions(aliasForm.toPropertyOptions(), null).getOptions()) : new AliasOptions();
/*     */ 
...
/*     */       {
/* 447 */         return actualPrefix + actualProp + " NS(" + actualNS + "), FORM (" + getAliasForm() + ")";
/*     */       }
/*     */     };
...
/*     */   {
/* 461 */     return Collections.unmodifiableMap(new TreeMap(this.aliasMap));
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.itextpdf.xmp.impl.XMPSchemaRegistryImpl
