...
/* 187 */       if ((input.hasNext()) && (input.ch() != ':') && (input.ch() != 'Z') && (input.ch() != '+') && (input.ch() != '-'))
/*     */       {
...
/* 203 */       if ((input.hasNext()) && (input.ch() != '.') && (input.ch() != 'Z') && (input.ch() != '+') && (input.ch() != '-'))
/*     */       {
...
/* 215 */         if ((input.hasNext()) && (input.ch() != 'Z') && (input.ch() != '+') && (input.ch() != '-'))
/*     */         {
/* 218 */           throw new XMPException("Invalid date string, after fractional second", 5);
/*     */         }
/*     */ 
/* 221 */         for (digits = input.pos() - digits; 
/* 222 */           digits > 9; digits--)
/*     */         {
/* 224 */           value /= 10;
/*     */         }
...
/*     */         {
/* 372 */           double seconds = dateTime.getSecond() + dateTime.getNanoSecond() / 1000000000.0D;
/*     */ 
 ...
 * Qualified Name:     com.itextpdf.xmp.impl.ISO8601Converter
