...
/*     */     {
/* 265 */       while ((pos.stepEnd < pos.path.length()) && ('0' <= pos.path.charAt(pos.stepEnd)) && (pos.path.charAt(pos.stepEnd) <= '9'))
/*     */       {
/* 267 */         pos.stepEnd += 1;
/*     */       }
/*     */ 
...
/*     */     else
/*     */     {
/* 277 */       while ((pos.stepEnd < pos.path.length()) && (pos.path.charAt(pos.stepEnd) != ']') && (pos.path.charAt(pos.stepEnd) != '='))
/*     */       {
/* 279 */         pos.stepEnd += 1;
/*     */       }
/*     */ 
...
/*     */           {
/* 314 */             if ((pos.stepEnd + 1 >= pos.path.length()) || (pos.path.charAt(pos.stepEnd + 1) != quote))
/*     */             {
/*     */               break;
/*     */             }
/*     */ 
...
/* 382 */       XMPPathSegment rootStep = new XMPPathSegment(verifyXPathRoot(aliasInfo.getNamespace(), aliasInfo.getPropName()), 1);
/*     */ 
 ...
 * Qualified Name:     com.itextpdf.xmp.impl.xpath.XMPPathParser
