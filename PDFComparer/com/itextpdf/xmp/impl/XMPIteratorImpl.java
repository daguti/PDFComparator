...
/*     */ 
/*  64 */   protected boolean skipSiblings = false;
/*     */ 
/*  66 */   protected boolean skipSubtree = false;
/*     */ 
...
/*     */   }
/*     */ 
/*     */   private class NodeIteratorChildren extends XMPIteratorImpl.NodeIterator
/*     */   {
...
/*     */       {
/* 599 */         XMPNode child = (XMPNode)this.childrenIterator.next();
/* 600 */         this.index += 1;
/*     */ 
...
/*     */     {
/* 335 */       this.state = 1;
/* 336 */       if ((this.visitedNode.getParent() != null) && ((!XMPIteratorImpl.this.getOptions().isJustLeafnodes()) || (!this.visitedNode.hasChildren())))
/*     */       {
...
/*     */       {
/* 367 */         XMPNode child = (XMPNode)iterator.next();
/* 368 */         this.index += 1;
/* 369 */         this.subIterator = new NodeIterator(XMPIteratorImpl.this, child, this.path, this.index);
/*     */       }
/*     */ 
/* 372 */       if (this.subIterator.hasNext())
/*     */       {
/* 374 */         this.returnProperty = ((XMPPropertyInfo)this.subIterator.next());
/* 375 */         return true;
/*     */       }
/*     */ 
/* 379 */       return false;
...
/*     */       {
/* 448 */         return !segmentName.startsWith("?") ? segmentName : segmentName.substring(1);
/*     */       }
/*     */ 
 ...
 * Qualified Name:     com.itextpdf.xmp.impl.XMPIteratorImpl
