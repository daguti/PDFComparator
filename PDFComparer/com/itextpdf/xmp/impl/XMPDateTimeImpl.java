...
/*  71 */   private boolean hasDate = false;
/*     */ 
/*  73 */   private boolean hasTime = false;
/*     */ 
/*  75 */   private boolean hasTimeZone = false;
/*     */ 
...
/*     */ 
/* 101 */     GregorianCalendar intCalendar = (GregorianCalendar)Calendar.getInstance(Locale.US);
/*     */ 
/* 103 */     intCalendar.setGregorianChange(new Date(-9223372036854775808L));
...
/*     */ 
/* 117 */     this.hasDate = (this.hasTime = this.hasTimeZone = 1);
/*     */   }
/*     */ 
...
/*     */ 
/* 143 */     this.hasDate = (this.hasTime = this.hasTimeZone = 1);
/*     */   }
/*     */ 
...
/*     */   {
/* 321 */     long d = getCalendar().getTimeInMillis() - ((XMPDateTime)dt).getCalendar().getTimeInMillis();
/*     */ 
/* 323 */     if (d != 0L)
/*     */     {
...
/* 389 */     calendar.setGregorianChange(new Date(-9223372036854775808L));
 ...
 * Qualified Name:     com.itextpdf.xmp.impl.XMPDateTimeImpl
