...
/*     */     {
/* 195 */       if (("xmp:BaseURL".equals(prop)) || ("xmp:CreatorTool".equals(prop)) || ("xmp:Format".equals(prop)) || ("xmp:Locale".equals(prop)) || ("xmp:MetadataDate".equals(prop)) || ("xmp:ModifyDate".equals(prop)))
/*     */       {
/* 199 */         isInternal = true;
/*     */       }
/*     */     }
...
/*     */     {
/* 204 */       if (("pdf:BaseURL".equals(prop)) || ("pdf:Creator".equals(prop)) || ("pdf:ModDate".equals(prop)) || ("pdf:PDFVersion".equals(prop)) || ("pdf:Producer".equals(prop)))
/*     */       {
/* 208 */         isInternal = true;
/*     */       }
/*     */     }
...
/*     */     {
/* 213 */       isInternal = true;
/* 214 */       if (("tiff:ImageDescription".equals(prop)) || ("tiff:Artist".equals(prop)) || ("tiff:Copyright".equals(prop)))
/*     */       {
...
/*     */     {
/* 241 */       if (("crs:Version".equals(prop)) || ("crs:RawFileName".equals(prop)) || ("crs:ToneCurveName".equals(prop)))
/*     */       {
/* 244 */         isInternal = true;
/*     */       }
/*     */     }
...
/*     */       case '>':
/* 427 */         buffer.append("&gt;"); break;
/*     */       case '&':
/* 428 */         buffer.append("&amp;"); break;
/*     */       case '"':
/* 429 */         buffer.append(forAttribute ? "&quot;" : "\""); break;
/*     */       default:
/* 430 */         buffer.append(c); continue;
/*     */ 
/* 437 */         buffer.append("&#x");
...
/*     */   {
/* 478 */     return ((ch <= 'ÿ') && (xmlNameStartChars[ch] != 0)) || ((ch >= 'Ā') && (ch <= '˿')) || ((ch >= 'Ͱ') && (ch <= 'ͽ')) || ((ch >= 'Ϳ') && (ch <= '῿')) || ((ch >= '‌') && (ch <= '‍')) || ((ch >= '⁰') && (ch <= '↏')) || ((ch >= 'Ⰰ') && (ch <= '⿯')) || ((ch >= '、') && (ch <= 55295)) || ((ch >= 63744) && (ch <= 64975)) || ((ch >= 65008) && (ch <= 65533)) || ((ch >= 65536) && (ch <= 983039));
/*     */   }
/*     */ 
/*     */   private static boolean isNameChar(char ch)
/*     */   {
/* 503 */     return ((ch <= 'ÿ') && (xmlNameChars[ch] != 0)) || (isNameStartChar(ch)) || ((ch >= '̀') && (ch <= 'ͯ')) || ((ch >= '‿') && (ch <= '⁀'));
/*     */   }
/*     */ 
...
/*     */ 
/* 521 */     for (char ch = '\000'; ch < xmlNameChars.length; ch = (char)(ch + '\001'))
/*     */     {
/* 523 */       xmlNameStartChars[ch] = ((ch == ':') || (('A' <= ch) && (ch <= 'Z')) || (ch == '_') || (('a' <= ch) && (ch <= 'z')) || (('À' <= ch) && (ch <= 'Ö')) || (('Ø' <= ch) && (ch <= 'ö')) || (('ø' <= ch) && (ch <= 'ÿ')) ? 1 : false);
/*     */ 
/* 532 */       xmlNameChars[ch] = ((xmlNameStartChars[ch] != 0) || (ch == '-') || (ch == '.') || (('0' <= ch) && (ch <= '9')) || (ch == '·') ? 1 : false);
/*     */     }
/*     */   }
/*     */ 
/*     */   static
 ...
 * Qualified Name:     com.itextpdf.xmp.impl.Utils
