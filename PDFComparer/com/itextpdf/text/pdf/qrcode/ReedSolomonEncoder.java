...
/*    */     }
/* 37 */     this.field = field;
/* 38 */     this.cachedGenerators = new ArrayList();
/* 39 */     this.cachedGenerators.add(new GF256Poly(field, new int[] { 1 }));
/*    */   }
/*    */ 
/*    */   private GF256Poly buildGenerator(int degree) {
/* 43 */     if (degree >= this.cachedGenerators.size()) {
/* 44 */       GF256Poly lastGenerator = (GF256Poly)this.cachedGenerators.get(this.cachedGenerators.size() - 1);
...
/*    */       }
/*    */     }
/* 51 */     return (GF256Poly)this.cachedGenerators.get(degree);
/*    */   }
/*    */ 
 ...
 * Qualified Name:     com.itextpdf.text.pdf.qrcode.ReedSolomonEncoder
