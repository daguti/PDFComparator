...
/* 108 */         result = GF256.addOrSubtract(result, this.coefficients[i]);
/*     */       }
/* 110 */       return result;
/*     */     }
...
/* 164 */         product[(i + j)] = GF256.addOrSubtract(product[(i + j)], this.field.multiply(aCoeff, bCoefficients[j]));
/*     */       }
/*     */     }
/*     */ 
 ...
 * Qualified Name:     com.itextpdf.text.pdf.qrcode.GF256Poly
