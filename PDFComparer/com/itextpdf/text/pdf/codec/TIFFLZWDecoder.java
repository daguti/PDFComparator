...
/*  64 */   int nextBits = 0;
/*     */ 
/*  66 */   int[] andTable = { 511, 1023, 2047, 4095 };
/*     */ 
...
/* 107 */     int oldCode = 0;
/*     */     int code;
/* 111 */     while (((code = getNextCode()) != 257) && (this.dstIndex < uncompData.length))
/*     */     {
/* 113 */       if (code == 256)
/*     */       {
...
/* 123 */         oldCode = code;
/*     */       }
/* 127 */       else if (code < this.tableIndex)
/*     */       {
/* 129 */         byte[] string = this.stringTable[code];
/*     */ 
/* 131 */         writeString(string);
/* 132 */         addStringToTable(this.stringTable[oldCode], string[0]);
/* 133 */         oldCode = code;
/*     */       }
/*     */       else
/*     */       {
...
/*     */         {
/*     */           int tmp288_286 = count;
/*     */           byte[] tmp288_285 = uncompData; tmp288_285[tmp288_286] = ((byte)(tmp288_285[tmp288_286] + uncompData[(count - this.samplesPerPixel)]));
/* 159 */           count++;
/*     */         }
/*     */       }
/*     */     }
 ...
 * Qualified Name:     com.itextpdf.text.pdf.codec.TIFFLZWDecoder
