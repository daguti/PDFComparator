...
/*     */   int numEntries;
/*     */   TIFFField[] fields;
/*  92 */   Hashtable<Integer, Integer> fieldIndex = new Hashtable();
/*     */ 
/*  95 */   long IFDOffset = 8L;
/*     */ 
/*  98 */   long nextIFDOffset = 0L;
/*     */ 
/* 206 */   private static final int[] sizeOfType = { 0, 1, 1, 2, 4, 8, 1, 1, 2, 4, 8, 4, 8 };
/*     */ 
/*     */   TIFFDirectory()
/*     */   {
/*     */   }
...
/*     */ 
/* 261 */       if (processTag) {
/* 262 */         this.fieldIndex.put(Integer.valueOf(tag), Integer.valueOf(i));
/* 263 */         Object obj = null;
/*     */         int j;
/* 265 */         switch (type) {
/*     */         case 1:
...
/* 273 */           if (type == 2)
/*     */           {
/* 276 */             int index = 0; int prevIndex = 0;
...
/*     */   {
/* 398 */     Integer i = (Integer)this.fieldIndex.get(Integer.valueOf(tag));
/* 399 */     if (i == null) {
/* 400 */       return null;
/*     */     }
...
/* 419 */     Enumeration e = this.fieldIndex.keys();
/* 420 */     int i = 0;
/*     */ 
...
/*     */   {
/* 444 */     Integer i = (Integer)this.fieldIndex.get(Integer.valueOf(tag));
...
/*     */   {
/* 466 */     Integer i = (Integer)this.fieldIndex.get(Integer.valueOf(tag));
...
/*     */   {
/* 487 */     Integer i = (Integer)this.fieldIndex.get(Integer.valueOf(tag));
...
/*     */   {
/* 507 */     Integer i = (Integer)this.fieldIndex.get(Integer.valueOf(tag));
 ...
 * Qualified Name:     com.itextpdf.text.pdf.codec.TIFFDirectory
