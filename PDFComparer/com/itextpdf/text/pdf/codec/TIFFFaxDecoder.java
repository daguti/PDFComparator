...
/*      */ 
/*  551 */   static byte[] twoDCodes = { 80, 88, 23, 71, 30, 30, 62, 62, 4, 4, 4, 4, 4, 4, 4, 4, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41 };
/*      */ 
...
/*  631 */     int bits = 0; int code = 0; int isT = 0;
/*      */ 
...
/*  781 */     int currIndex = 0;
/*      */ 
/*  790 */     this.oneD = ((int)(tiffT4Options & 1L));
/*  791 */     this.uncompressedMode = ((int)((tiffT4Options & 0x2) >> 1));
/*  792 */     this.fillBits = ((int)((tiffT4Options & 0x4) >> 2));
/*      */ 
...
/*  935 */     int[] b = new int[2];
/*      */ 
/*  940 */     this.uncompressedMode = ((int)((tiffT6Options & 0x2) >> 1));
/*      */ 
...
/*      */ 
/*  976 */       while ((bitOffset < this.w) && (this.bytePointer < this.data.length))
/*      */       {
...
/*      */ 
/* 1043 */           updatePointer(7 - bits);
/* 1044 */         } else if (code == 11) {
...
/*      */       {
/*      */         int tmp149_147 = byteNum;
/*      */         byte[] tmp149_146 = buffer; tmp149_146[tmp149_147] = ((byte)(tmp149_146[tmp149_147] | 1 << 7 - (bitNum & 0x7)));
/*      */       }
/* 1170 */       bitNum++;
/*      */     }
/*      */   }
...
/* 1196 */         runLength += code;
/* 1197 */         updatePointer(4 - bits); } else {
/* 1198 */         if (bits == 0)
...
/* 1251 */           runLength += code;
/*      */ 
/* 1253 */           updatePointer(4 - bits); } else {
/* 1254 */           if (bits == 15)
/*      */           {
...
/*      */     byte next2next;
/* 1384 */     if (this.fillOrder == 1) {
/* 1385 */       byte b = this.data[bp];
/*      */       byte next2next;
/* 1387 */       if (bp == l) {
/* 1388 */         byte next = 0;
/* 1389 */         next2next = 0;
...
/*      */         byte next2next;
/* 1390 */         if (bp + 1 == l) {
/* 1391 */           byte next = this.data[(bp + 1)];
/* 1392 */           next2next = 0;
/*      */         } else {
/* 1394 */           byte next = this.data[(bp + 1)];
...
/*      */     {
/*      */       byte next2next;
/* 1397 */       if (this.fillOrder == 2) {
/* 1398 */         byte b = flipTable[(this.data[bp] & 0xFF)];
/*      */         byte next2next;
/* 1400 */         if (bp == l) {
/* 1401 */           byte next = 0;
/* 1402 */           next2next = 0;
...
/*      */           byte next2next;
/* 1403 */           if (bp + 1 == l) {
/* 1404 */             byte next = flipTable[(this.data[(bp + 1)] & 0xFF)];
/* 1405 */             next2next = 0;
/*      */           } else {
/* 1407 */             byte next = flipTable[(this.data[(bp + 1)] & 0xFF)];
/* 1408 */             next2next = flipTable[(this.data[(bp + 2)] & 0xFF)];
/*      */           }
/*      */         }
/*      */       } else { throw new RuntimeException(MessageLocalization.getComposedMessage("tiff.fill.order.tag.must.be.either.1.or.2", new Object[0])); }
/*      */ 
/*      */     }
/*      */     byte next2next;
/*      */     byte next;
 ...
 * Qualified Name:     com.itextpdf.text.pdf.codec.TIFFFaxDecoder
