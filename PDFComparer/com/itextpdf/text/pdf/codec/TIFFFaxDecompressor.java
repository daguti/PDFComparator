...
/*      */ 
/*  559 */   static byte[] twoDCodes = { 80, 88, 23, 71, 30, 30, 62, 62, 4, 4, 4, 4, 4, 4, 4, 4, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 35, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 51, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41 };
/*      */ 
...
/*  659 */     int bits = 0; int code = 0; int isT = 0;
/*      */ 
...
/*  723 */         if ((!isWhite) || (runLength == 0) || (runLength % 64 != 0) || (nextNBits(8) == 53)) {
/*      */           break;
/*      */         }
/*  726 */         this.fails += 1;
/*  727 */         updatePointer(8); break;
/*      */       }
/*      */ 
...
/*  813 */         if ((isWhite) || (runLength == 0) || (runLength % 64 != 0) || (nextNBits(10) == 55)) {
/*      */           break;
/*      */         }
/*  816 */         this.fails += 1;
/*  817 */         updatePointer(10); break;
/*      */       }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       int tmp130_128 = byteNum;
/*      */       byte[] tmp130_125 = this.buffer; tmp130_125[tmp130_128] = ((byte)(tmp130_125[tmp130_128] | 1 << 7 - (bitNum & 0x7)));
/* 1231 */       bitNum++;
/*      */     }
/*      */   }
/*      */ 
...
/* 1257 */         runLength += code;
/* 1258 */         updatePointer(4 - bits); } else {
/* 1259 */         if (bits == 0)
...
/* 1308 */           runLength += code;
/*      */ 
/* 1310 */           updatePointer(4 - bits); } else {
/* 1311 */           if (bits == 15)
/*      */           {
...
/* 1356 */         next12Bits = (next12Bits & 0x7FF) << 1 | nextLesserThan8Bits(1) & 0x1;
/*      */ 
/* 1359 */         bitIndex++;
/*      */       }
/*      */ 
...
/*      */         byte next2next;
/* 1419 */         if (bp + 1 == l) {
/* 1420 */           byte next = this.data[(bp + 1)];
/* 1421 */           next2next = 0;
/*      */         } else {
/* 1423 */           byte next = this.data[(bp + 1)];
...
/*      */     {
/*      */       byte next2next;
/* 1426 */       if (this.fillOrder == 2) {
/* 1427 */         byte b = flipTable[(this.data[bp] & 0xFF)];
/*      */         byte next2next;
/* 1429 */         if (bp == l) {
/* 1430 */           byte next = 0;
/* 1431 */           next2next = 0;
...
/*      */           byte next2next;
/* 1432 */           if (bp + 1 == l) {
/* 1433 */             byte next = flipTable[(this.data[(bp + 1)] & 0xFF)];
/* 1434 */             next2next = 0;
/*      */           } else {
/* 1436 */             byte next = flipTable[(this.data[(bp + 1)] & 0xFF)];
/* 1437 */             next2next = flipTable[(this.data[(bp + 2)] & 0xFF)];
/*      */           }
/*      */         }
/*      */       } else { throw new RuntimeException("Invalid FillOrder"); }
/*      */ 
/*      */     }
/*      */     byte next2next;
/*      */     byte next;
...
/*      */   {
/* 1479 */     int l = this.data.length - 1;
/* 1480 */     int bp = this.bytePointer;
/*      */     byte next;
/* 1482 */     if (this.fillOrder == 1) {
/* 1483 */       byte b = this.data[bp];
/*      */       byte next;
/* 1484 */       if (bp == l)
/* 1485 */         next = 0;
/*      */       else
...
/*      */     {
/*      */       byte next;
/* 1489 */       if (this.fillOrder == 2) {
/* 1490 */         byte b = flipTable[(this.data[bp] & 0xFF)];
/*      */         byte next;
/* 1491 */         if (bp == l)
/* 1492 */           next = 0;
/*      */         else
 ...
 * Qualified Name:     com.itextpdf.text.pdf.codec.TIFFFaxDecompressor
