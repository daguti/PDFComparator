...
/* 318 */     int hash = (int)(key ^ key >>> 32);
/* 319 */     int index = (hash & 0x7FFFFFFF) % tab.length;
/* 320 */     Entry e = tab[index]; for (Entry prev = null; e != null; e = e.next) {
...
/*     */     while (true)
/* 442 */       if ((entry != null) || 
/* 443 */         (index-- <= 0) || ((entry = this.table[index]) != null)) {
/* 444 */         if (entry == null)
/*     */           break;
/* 446 */         Entry e = entry;
/* 447 */         entry = e.next;
...
/* 470 */         t.table[i] = (this.table[i] != null ? (Entry)this.table[i].clone() : null);
/*     */       }
/*     */ 
/* 473 */       return t;
...
/*     */     implements Iterator<LongHashtable.Entry>
/*     */   {
/*     */     int index;
...
/* 409 */       while ((this.entry == null) && 
/* 410 */         (this.index-- > 0) && ((this.entry = this.table[this.index]) == null));
 ...
 * Qualified Name:     com.itextpdf.text.pdf.LongHashtable
