...
/*     */     }
/*     */ 
/* 145 */     this.recipients = new ArrayList();
/*     */   }
/*     */ 
...
/*     */   {
/* 167 */     PdfPublicKeyRecipient recipient = (PdfPublicKeyRecipient)this.recipients.get(index);
...
/*     */ 
/* 198 */     DEROutputStream k = new DEROutputStream(baos);
/*     */ 
...
/* 216 */         EncodedRecipients.add(new PdfLiteral(PdfContentByte.escapeString(cms)));
...
/* 246 */     DERSet derset = new DERSet(new RecipientInfo(keytransrecipientinfo));
/* 247 */     AlgorithmIdentifier algorithmidentifier = new AlgorithmIdentifier(new ASN1ObjectIdentifier(s), derobject);
/* 248 */     EncryptedContentInfo encryptedcontentinfo = new EncryptedContentInfo(PKCSObjectIdentifiers.data, algorithmidentifier, deroctetstring);
/*     */ 
/* 250 */     ASN1Set set = null;
/* 251 */     EnvelopedData env = new EnvelopedData(null, derset, encryptedcontentinfo, set);
/* 252 */     ContentInfo contentinfo = new ContentInfo(PKCSObjectIdentifiers.envelopedData, env);
/*     */ 
...
/*     */   {
/* 260 */     ASN1InputStream asn1inputstream = new ASN1InputStream(new ByteArrayInputStream(x509certificate.getTBSCertificate()));
/*     */ 
/* 262 */     TBSCertificateStructure tbscertificatestructure = TBSCertificateStructure.getInstance(asn1inputstream.readObject());
/*     */ 
/* 264 */     AlgorithmIdentifier algorithmidentifier = tbscertificatestructure.getSubjectPublicKeyInfo().getAlgorithm();
/* 265 */     IssuerAndSerialNumber issuerandserialnumber = new IssuerAndSerialNumber(tbscertificatestructure.getIssuer(), tbscertificatestructure.getSerialNumber().getValue());
/*     */ 
...
/* 277 */     return new KeyTransRecipientInfo(recipId, algorithmidentifier, deroctetstring);
/*     */   }
/*     */ }

/* Location:           C:\Users\ESa10969\Desktop\PDFComparer\
 * Qualified Name:     com.itextpdf.text.pdf.PdfPublicKeySecurityHandler
