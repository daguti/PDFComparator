...
/* 201 */     int hash = key;
/* 202 */     int index = (hash & 0x7FFFFFFF) % tab.length;
...
/* 273 */       for (old = oldMap[i]; old != null; ) {
/* 274 */         Entry e = old;
/* 275 */         old = old.next;
/*     */ 
/* 277 */         int index = (e.hash & 0x7FFFFFFF) % newCapacity;
...
/* 302 */     int hash = key;
/* 303 */     int index = (hash & 0x7FFFFFFF) % tab.length;
/* 304 */     for (Entry e = tab[index]; e != null; e = e.next) {
...
/*     */ 
/* 317 */       tab = this.table;
/* 318 */       index = (hash & 0x7FFFFFFF) % tab.length;
/*     */     }
/*     */ 
/* 322 */     Entry e = new Entry(hash, key, value, tab[index]);
/* 323 */     tab[index] = e;
/* 324 */     this.count += 1;
/* 325 */     return 0;
/*     */   }
...
/* 343 */     Entry e = tab[index]; for (Entry prev = null; e != null; e = e.next) {
...
/*     */     while (true)
/* 476 */       if ((entry != null) || 
/* 477 */         (index-- <= 0) || ((entry = this.table[index]) != null)) {
/* 478 */         if (entry == null)
/*     */           break;
/* 480 */         Entry e = entry;
/* 481 */         entry = e.next;
...
/* 504 */         t.table[i] = (this.table[i] != null ? (Entry)this.table[i].clone() : null);
/*     */       }
/*     */ 
/* 507 */       return t;
...
/*     */     implements Iterator<IntHashtable.Entry>
/*     */   {
/*     */     int index;
...
/* 443 */       while ((this.entry == null) && 
/* 444 */         (this.index-- > 0) && ((this.entry = this.table[this.index]) == null));
 ...
 * Qualified Name:     com.itextpdf.text.pdf.IntHashtable
