...
/*     */   {
/* 378 */     setCurve(p1.getX(), p1.getY(), cp1.getX(), cp1.getY(), cp2.getX(), cp2.getY(), p2.getX(), p2.getY());
/*     */   }
/*     */ 
...
/*     */   {
/* 394 */     setCurve(points[(offset + 0)].getX(), points[(offset + 0)].getY(), points[(offset + 1)].getX(), points[(offset + 1)].getY(), points[(offset + 2)].getX(), points[(offset + 2)].getY(), points[(offset + 3)].getX(), points[(offset + 3)].getY());
/*     */   }
/*     */ 
/*     */   public void setCurve(CubicCurve2D curve)
/*     */   {
/* 402 */     setCurve(curve.getX1(), curve.getY1(), curve.getCtrlX1(), curve.getCtrlY1(), curve.getCtrlX2(), curve.getCtrlY2(), curve.getX2(), curve.getY2());
/*     */   }
/*     */ 
/*     */   public double getFlatnessSq()
/*     */   {
/* 410 */     return getFlatnessSq(getX1(), getY1(), getCtrlX1(), getCtrlY1(), getCtrlX2(), getCtrlY2(), getX2(), getY2());
/*     */   }
/*     */ 
...
/*     */   {
/* 420 */     return Math.max(Line2D.ptSegDistSq(x1, y1, x2, y2, ctrlx1, ctrly1), Line2D.ptSegDistSq(x1, y1, x2, y2, ctrlx2, ctrly2));
/*     */   }
/*     */ 
...
/*     */   {
/* 434 */     return getFlatness(getX1(), getY1(), getCtrlX1(), getCtrlY1(), getCtrlX2(), getCtrlY2(), getX2(), getY2());
/*     */   }
/*     */ 
...
/*     */   {
/*     */     try {
/* 580 */       return super.clone(); } catch (CloneNotSupportedException e) {
/*     */     }
 ...
 * Qualified Name:     com.itextpdf.awt.geom.CubicCurve2D
