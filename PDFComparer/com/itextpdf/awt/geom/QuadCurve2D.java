...
/*     */   {
/* 333 */     setCurve(points[(offset + 0)].getX(), points[(offset + 0)].getY(), points[(offset + 1)].getX(), points[(offset + 1)].getY(), points[(offset + 2)].getX(), points[(offset + 2)].getY());
/*     */   }
/*     */ 
/*     */   public void setCurve(QuadCurve2D curve)
/*     */   {
/* 340 */     setCurve(curve.getX1(), curve.getY1(), curve.getCtrlX(), curve.getCtrlY(), curve.getX2(), curve.getY2());
/*     */   }
/*     */ 
/*     */   public double getFlatnessSq()
/*     */   {
/* 347 */     return Line2D.ptSegDistSq(getX1(), getY1(), getX2(), getY2(), getCtrlX(), getCtrlY());
/*     */   }
/*     */ 
...
/*     */   {
/*     */     try {
/* 488 */       return super.clone(); } catch (CloneNotSupportedException e) {
/*     */     }
 ...
 * Qualified Name:     com.itextpdf.awt.geom.QuadCurve2D
