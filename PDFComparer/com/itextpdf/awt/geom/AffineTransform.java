...
/*     */   static final double ZERO = 1.0E-010D;
/*     */   double m00;
/*     */   double m10;
/*     */   double m01;
/*     */   double m11;
...
/* 298 */     if (Math.abs(cos) < 1.0E-010D) {
/* 299 */       cos = 0.0D;
/* 300 */       sin = sin > 0.0D ? 1.0D : -1.0D;
/*     */     }
/* 302 */     else if (Math.abs(sin) < 1.0E-010D) {
/* 303 */       sin = 0.0D;
...
/*     */     while (true) { length--; if (length < 0) break;
...
/*     */   {
/* 592 */     return getClass().getName() + "[[" + this.m00 + ", " + this.m01 + ", " + this.m02 + "], [" + this.m10 + ", " + this.m11 + ", " + this.m12 + "]]";
/*     */   }
/*     */ 
/*     */   public Object clone()
/*     */   {
/*     */     try
/*     */     {
/* 601 */       return super.clone(); } catch (CloneNotSupportedException e) {
/*     */     }
 ...
 * Qualified Name:     com.itextpdf.awt.geom.AffineTransform
