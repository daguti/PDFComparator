...
/*     */ {
/*     */   static final double DELTA = 1.E-005D;
/*     */   static final double ROOT_DELTA = 1.0E-010D;
...
/* 107 */       double p = 2.094395102393195D;
...
/*     */       }
/*     */ 
/* 119 */       if ((-1.0E-010D < A) && (A < 1.0E-010D)) {
/* 120 */         res[(rc++)] = n;
/*     */       } else {
/* 122 */         double B = Q / A;
/* 123 */         res[(rc++)] = (A + B + n);
...
/* 126 */         if ((-1.0E-010D < delta) && (delta < 1.0E-010D)) {
...
/*     */   {
/* 142 */     int tc = 0;
/* 143 */     label52: for (int i = 0; i < rc; i++)
/*     */     {
/* 145 */       for (int j = i + 1; j < rc; j++) {
...
/*     */   {
/* 527 */     return (-1.E-005D < val) && (val < 1.E-005D);
/*     */   }
/*     */ 
...
/* 592 */       for (int i = 6; i < bc; i += 4) {
/* 593 */         boolean sign2 = bound[i] > py2;
/* 594 */         if ((sign != sign2) && (bound[(i + 1)] != bound[(i - 3)])) {
/* 595 */           return 255;
/*     */         }
/* 597 */         sign = sign2;
/*     */       }
...
/*     */     }
/*     */ 
/* 711 */     double minX = px1 - 1.E-005D;
/* 712 */     double maxX = px2 + 1.E-005D;
...
/*     */     }
/*     */ 
/* 781 */     double minX = px1 - 1.E-005D;
/* 782 */     double maxX = px2 + 1.E-005D;
/*     */ 
...
/* 286 */         double t = res[i];
/*     */ 
/* 289 */         if ((t >= -1.E-005D) && (t <= 1.00001D))
/*     */         {
/* 293 */           if (t < 1.E-005D) {
/* 294 */             if (py1 < 0.0D) if ((this.cx != this.bx ? this.cx - this.bx : this.bx != 0.0D ? this.bx : this.ax - this.cx) < 0.0D) {
/* 295 */                 cross--;
/*     */               }
/*     */ 
/*     */ 
/*     */           }
/* 300 */           else if (t > 0.9999900000000001D) {
/* 301 */             if (py1 < this.ay) if ((this.cx != this.bx ? this.cx - this.bx : this.ax != this.cx ? this.ax - this.cx : this.bx) > 0.0D) {
/* 302 */                 cross++;
/*     */               }
/*     */           }
/*     */           else
...
/*     */ 
/* 312 */               if ((rxt > -1.E-005D) && (rxt < 1.E-005D)) {
/* 313 */                 rxt = t * (this.Ax3 + this.Ax3) + this.Bx2;
/*     */ 
/* 315 */                 if ((rxt >= -1.E-005D) && (rxt <= 1.E-005D))
/*     */                 {
/* 319 */                   rxt = this.ax;
/*     */                 }
/*     */               } else { cross += (rxt > 0.0D ? 1 : -1); } 
/*     */             }
/*     */           }
/*     */         }
/*     */       }
...
/* 181 */         double t = res[i];
/*     */ 
/* 184 */         if ((t >= -1.E-005D) && (t <= 1.00001D))
/*     */         {
/* 188 */           if (t < 1.E-005D) {
/* 189 */             if (py1 < 0.0D) if ((this.bx != 0.0D ? this.bx : this.ax - this.bx) < 0.0D) {
/* 190 */                 cross--;
/*     */               }
/*     */ 
/*     */ 
/*     */           }
/* 195 */           else if (t > 0.9999900000000001D) {
/* 196 */             if (py1 < this.ay) if ((this.ax != this.bx ? this.ax - this.bx : this.bx) > 0.0D) {
/* 197 */                 cross++;
/*     */               }
/*     */           }
/*     */           else
...
/*     */ 
/* 207 */               if ((rxt <= -1.E-005D) || (rxt >= 1.E-005D))
/*     */               {
 ...
 * Qualified Name:     com.itextpdf.awt.geom.gl.Crossing
