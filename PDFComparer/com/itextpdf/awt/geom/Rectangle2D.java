...
/* 446 */     return ((rx1 <= x1) && (x1 <= rx2) && (ry1 <= y1) && (y1 <= ry2)) || ((rx1 <= x2) && (x2 <= rx2) && (ry1 <= y2) && (y2 <= ry2)) || (Line2D.linesIntersect(rx1, ry1, rx2, ry2, x1, y1, x2, y2)) || (Line2D.linesIntersect(rx2, ry1, rx1, ry2, x1, y1, x2, y2));
/*     */   }
/*     */ 
...
/* 564 */       return (getX() == r.getX()) && (getY() == r.getY()) && (getWidth() == r.getWidth()) && (getHeight() == r.getHeight());
/*     */     }
/*     */ 
/* 570 */     return false;
/*     */   }
 ...
 * Qualified Name:     com.itextpdf.awt.geom.Rectangle2D
