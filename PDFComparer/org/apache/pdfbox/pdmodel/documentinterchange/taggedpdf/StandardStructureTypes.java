...
/*     */ {
/*  39 */   private static final Log LOG = LogFactory.getLog(StandardStructureTypes.class);
...
/* 300 */   public static List<String> types = new ArrayList();
/*     */ 
/*     */   static
/*     */   {
/* 304 */     Field[] fields = StandardStructureTypes.class.getFields();
/* 305 */     for (int i = 0; i < fields.length; i++)
/*     */     {
/* 307 */       if (Modifier.isFinal(fields[i].getModifiers()))
/*     */       {
/*     */         try
/*     */         {
/* 311 */           types.add(fields[i].get(null).toString());
/*     */         }
 ...
 * Qualified Name:     org.apache.pdfbox.pdmodel.documentinterchange.taggedpdf.StandardStructureTypes
