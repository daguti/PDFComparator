...
/*     */     else
/*     */     {
/* 118 */       permissions &= (0xFFFFFFFF ^ 1 << bit - 1);
/*     */     }
...
/*     */   {
/* 136 */     return (canAssembleDocument()) && (canExtractContent()) && (canExtractForAccessibility()) && (canFillInForm()) && (canModify()) && (canModifyAnnotations()) && (canPrint()) && (canPrintDegraded());
/*     */   }
/*     */ 
...
/*     */     {
/* 220 */       setPermissionBit(3, allowPrinting);
/*     */     }
/*     */   }
/*     */ 
/*     */   public boolean canModify()
/*     */   {
/* 231 */     return isPermissionBitOn(4);
/*     */   }
/*     */ 
...
/*     */     {
/* 244 */       setPermissionBit(4, allowModifications);
/*     */     }
/*     */   }
/*     */ 
/*     */   public boolean canExtractContent()
/*     */   {
/* 256 */     return isPermissionBitOn(5);
/*     */   }
/*     */ 
...
/*     */     {
/* 270 */       setPermissionBit(5, allowExtraction);
/*     */     }
/*     */   }
/*     */ 
/*     */   public boolean canModifyAnnotations()
/*     */   {
/* 281 */     return isPermissionBitOn(6);
/*     */   }
/*     */ 
...
/*     */     {
/* 294 */       setPermissionBit(6, allowAnnotationModification);
/*     */     }
/*     */   }
/*     */ 
/*     */   public boolean canFillInForm()
/*     */   {
/* 305 */     return isPermissionBitOn(9);
/*     */   }
/*     */ 
...
/*     */     {
/* 318 */       setPermissionBit(9, allowFillingInForm);
/*     */     }
/*     */   }
/*     */ 
/*     */   public boolean canExtractForAccessibility()
/*     */   {
/* 331 */     return isPermissionBitOn(10);
/*     */   }
/*     */ 
...
/*     */     {
/* 345 */       setPermissionBit(10, allowExtraction);
/*     */     }
/*     */   }
/*     */ 
/*     */   public boolean canAssembleDocument()
/*     */   {
/* 357 */     return isPermissionBitOn(11);
/*     */   }
/*     */ 
...
/*     */     {
/* 370 */       setPermissionBit(11, allowAssembly);
/*     */     }
/*     */   }
/*     */ 
/*     */   public boolean canPrintDegraded()
/*     */   {
/* 382 */     return isPermissionBitOn(12);
/*     */   }
/*     */ 
...
/*     */     {
/* 396 */       setPermissionBit(12, allowAssembly);
/*     */     }
/*     */   }
/*     */ 
/*     */   public void setReadOnly()
/*     */   {
/* 408 */     this.readOnly = true;
/*     */   }
/*     */ 
...
/*     */   {
/* 429 */     if (canFillInForm())
/*     */     {
/* 431 */       return true;
/*     */     }
/* 433 */     if (canExtractForAccessibility())
/*     */     {
/* 435 */       return true;
/*     */     }
/* 437 */     if (canAssembleDocument())
/*     */     {
/* 439 */       return true;
/*     */     }
/* 441 */     if (canPrintDegraded())
/*     */     {
/* 443 */       return true;
/*     */     }
/* 445 */     return false;
 ...
 * Qualified Name:     org.apache.pdfbox.pdmodel.encryption.AccessPermission
