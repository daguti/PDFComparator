...
/*     */     else
/*     */     {
/* 103 */       this.argument1 = ((short)bais.readUnsignedByte());
/* 104 */       this.argument2 = ((short)bais.readUnsignedByte());
/*     */     }
/*     */ 
...
/*     */     }
/*     */ 
/* 121 */     if ((this.flags & 0x8) != 0)
/*     */     {
/* 123 */       int i = bais.readSignedShort();
/* 124 */       this.xscale = (this.yscale = i / 16384.0D);
/*     */     }
/* 126 */     else if ((this.flags & 0x40) != 0)
/*     */     {
/* 128 */       short i = bais.readSignedShort();
/* 129 */       this.xscale = (i / 16384.0D);
/* 130 */       i = bais.readSignedShort();
/* 131 */       this.yscale = (i / 16384.0D);
/*     */     }
/* 133 */     else if ((this.flags & 0x80) != 0)
/*     */     {
/* 135 */       int i = bais.readSignedShort();
 ...
 * Qualified Name:     org.apache.fontbox.ttf.GlyfCompositeComp
