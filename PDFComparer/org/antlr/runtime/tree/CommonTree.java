...
/*     */     }
/* 148 */     if ((this.startIndex >= 0) && (this.stopIndex >= 0)) return;
/* 149 */     if (this.children.size() > 0) {
/* 150 */       CommonTree firstChild = (CommonTree)this.children.get(0);
/* 151 */       CommonTree lastChild = (CommonTree)this.children.get(this.children.size() - 1);
