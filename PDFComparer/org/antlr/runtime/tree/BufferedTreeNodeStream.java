...
/* 461 */     while (t != stop) {
/* 462 */       String text = this.adaptor.getText(t);
/* 463 */       if (text == null) {
/* 464 */         text = " " + String.valueOf(this.adaptor.getType(t));
/*     */       }
/* 466 */       buf.append(text);
/* 467 */       i++;
...
/*  64 */     public boolean hasNext() { return this.i < BufferedTreeNodeStream.this.nodes.size(); }
/*     */ 
/*     */     public Object next()
/*     */     {
 ...
 * Qualified Name:     org.antlr.runtime.tree.BufferedTreeNodeStream
