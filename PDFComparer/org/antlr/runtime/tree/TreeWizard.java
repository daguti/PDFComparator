...
/* 199 */     visit(t, ttype, new Visitor() { private final List val$nodes;
/*     */ 
/* 201 */       public void visit(Object t) { nodes.add(t); }
/*     */ 
/*     */     });
/* 204 */     return nodes;
/*     */   }
...
/*     */ 
/* 225 */       public void visit(Object t, Object parent, int childIndex, Map labels) { if (TreeWizard.this._parse(t, tpattern, null))
/* 226 */           subtrees.add(t);
/*     */       }
/*     */     });
/* 230 */     return subtrees;
...
/* 285 */     visit(t, rootTokenType, new ContextVisitor() { private final Map val$labels;
/*     */       private final TreeWizard.TreePattern val$tpattern;
/*     */       private final TreeWizard.ContextVisitor val$visitor;
/*     */ 
/* 288 */       public void visit(Object t, Object parent, int childIndex, Map unusedlabels) { labels.clear();
...
/*     */   }
/*     */ 
/*     */   public static class WildcardTreePattern extends TreeWizard.TreePattern
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public static abstract interface ContextVisitor
/*     */   {
/*     */     public abstract void visit(Object paramObject1, Object paramObject2, int paramInt, Map paramMap);
/*     */   }
/*     */ }

/* Location:           C:\Users\ESa10969\Desktop\PDFComparer\
 * Qualified Name:     org.antlr.runtime.tree.TreeWizard
