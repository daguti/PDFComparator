...
/*  54 */       return null;
/*     */     }
/*  56 */     return (Tree)this.children.get(i);
/*     */   }
/*     */ 
...
/*  68 */       Tree t = (Tree)this.children.get(i);
...
/* 156 */       return null;
/*     */     }
/* 158 */     Tree killed = (Tree)this.children.remove(i);
/*     */ 
...
/* 197 */         BaseTree child = (BaseTree)newChildren.get(j);
...
/* 222 */       for (int j = replacingHowMany; j < replacingWithHowMany; j++) {
/* 223 */         this.children.add(startChildIndex + j, newChildren.get(j));
/*     */       }
...
/* 327 */       Tree t = (Tree)this.children.get(i);
/* 328 */       if (i > 0) {
/* 329 */         buf.append(' ');
/*     */       }
